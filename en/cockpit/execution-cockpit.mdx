...
<Frame caption="The Cockpit before a plan is chosen: nothing is computed until you select one.">
  <img src="/images/en/cockpit-01-no-plan.png" alt="TestPulse Cockpit tab with only the test plan selector visible" />
</Frame>
