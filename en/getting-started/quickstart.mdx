...
<Frame caption="The Report tab on arrival: plan selection on the left, the report panel on the right.">
  <img src="/images/en/quickstart-01-report.png" alt="TestPulse Report tab, plan selection form and empty report panel" />
</Frame>
...
<Steps>
  ...
  <Step title="Choose an export format" icon="file-output">
    Select a format:
    <CardGroup cols={2}>
      <Card title="PDF" icon="printer">Polished, printable, signed.</Card>
      <Card title="Word" icon="file-pen">Editable, signed.</Card>
      <Card title="Excel" icon="file-spreadsheet">Data-oriented.</Card>
...
<CardGroup cols={2}>
  ...
  <Card title="The work-item signal" icon="list-checks">
    See the "Test coverage" tab and execution verdict on a user story.
  </Card>
  <Card title="Exports in depth" icon="file-output">
