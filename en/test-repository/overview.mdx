...
<Frame caption="The Repository opens on the Hygiene view, before any analysis is run.">
  <img src="/images/en/repository-hygiene.png" alt="Test Repository tab on the Hygiene view before analysis" />
</Frame>
