...
<Tip>TestPulse n'écrit jamais de lui-même : chaque écriture suit un geste explicite. Il ne modifie jamais un work item, plan, suite ou résultat antérieur à ce geste — voir [Permissions & scopes](/fr/security/permissions).</Tip>