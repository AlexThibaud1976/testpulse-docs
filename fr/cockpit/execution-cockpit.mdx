...
<Frame caption="Le Cockpit avant tout choix de plan : rien n'est calculé tant que vous n'en avez pas sélectionné un.">
  <img src="/images/fr/cockpit-01-no-plan.png" alt="Onglet Cockpit de TestPulse avec seul le sélecteur de plan de test visible" />
</Frame>
