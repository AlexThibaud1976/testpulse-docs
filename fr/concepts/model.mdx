...
TestPulse parcourt l'arbre en **lecture seule** : plan → suites → cas → points → derniers résultats. Il ne modifie jamais rien qu'il n'ait créé lui-même (voir [Coverage Builder](/fr/concepts/read-only) opt-in).
